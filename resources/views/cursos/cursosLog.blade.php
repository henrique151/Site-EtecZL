...
<div class="relative isolate overflow-hidden bg-black py-24 sm:py-32 dark:bg-white-dark min-h-[630px] after:content-[''] after:h-full after:w-full after:absolute after:left-0 after:top-0 after:bg-[#1414149c] ">
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="font-bold text-white text-sm mb-10 z-50 mt-24 ml-14">LOGÍSTICA</h2>
      <p class=" text-white text-3xl -bottom-2 relative tracking-tight font-bold z-50 ml-14">Rumo à Eficiência: Explorando os Segredos da </br>cLogística com Matemática, Geografia e Física!</p>
    </div>
...
<div class="flex flex-col justify-left md:flex-row items-center mt-5 text-white p-8 md:px-20">
    <div class="md:w-2/2 md:ml-10">
        ...
        <p class="font-normal text-base mb-7 text-justify" style="color: #CDC0C0">Pesquisa preços com fornecedores para elaborar orçamentos de compra de produtos e de transporte de mercadorias; controla a entrada e a saída de mercadorias do estoque; confere os produtos recebidos de acordo com a nota fiscal, verificando defeitos, prazos de validades, além de resolver os procedimentos para a devolução dos itens com problema; separa no estoque as mercadorias que foram compradas para serem despachadas; dimensiona as quantidades de cargas e de produtos que cabem em cada tipo de transporte (moto, caminhão, navio, avião) e em cada local de estoque; pesquisa e sugere opções de transporte e rotas conforme a carga; realiza o rastreamento do produto ou mercadoria que está sendo transportado e acompanha o fluxo de entrega para alimentar os bancos de dados da empresa. </p>
  </div>
</div>
