...
<div class="relative isolate overflow-hidden bg-black py-24 sm:py-32 dark:bg-white-dark min-h-[630px] after:content-[''] after:h-full after:w-full after:absolute after:left-0 after:top-0 after:bg-[#1414149c] ">
  <img src="https://www.eteczonaleste.com.br/wp-content/uploads/2023/11/tingey-injury-law-firm-yCdPU73kGSc-unsplash-scaled.jpg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center after:bg-[#1414149c]">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="font-bold text-white text-sm mb-10 z-50 mt-24 ml-14">SERVIÇOS JURÍDICOS</h2>
      <p class="text-white text-3xl -bottom-2 relative tracking-tight font-bold z-50 ml-14">Explorando o Mundo Jurídico: Curso Técnico em Direito e Administração – Uma Jornada pelos  Pilares Legais da Sociedade!</p>
    </div>
...
<div class="flex flex-col justify-center md:flex-row items-center mt-5 text-white p-8 md:px-20">
    <div class="md:w-11/12 ">
        ...
        <p class="font-normal text-base mb-7 text-justify" style="color: #CDC0C0">Auxilia o advogado e oferece apoio técnico e administrativo a empresas. Presta atendimento ao público; verifica os prazos de cada etapa de um processo judicial; calcula valores dos honorários dos advogados e dos custos de um processo; recebe e envia documentos, registrando a movimentação em sistemas ou livros de protocolo; redige contratos, ofícios, processos e cartas comerciais e arquiva processos, entre outras atividades.</p>
  </div>
</div>
...
<div class="flex flex-col justify-center md:flex-row items-center mt-5 text-white p-8 md:px-20">
    ...
    <div class="md:w-5/12 md:ml-24 md:order-2">
        <h1 class="text-2xl font-bold mb-4" style="color: #E1E1D4">Onde Trabalhar</h1>
        <p class="font-normal text-base text-justify" style="color: #CDC0C0">Nos setores jurídico, de recursos humanos e de administração de empresas públicas e privadas, em escritórios de advocacia, empresas de auditoria jurídica, fóruns e cartórios.</p> 
    </div>
</div>
