...
<nav class="bg-black">
    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class=" sm:flex flex-1 justify-end items-center">
        <div class="nav-links flex space-x-4">
          ...
          <a href="/" class="hover:bg-red-600 text-gray-300 rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Início</a>
          <div class="relative">
            <button type="button" class="dropdown-toggle py-2 px-3 bg-red-600 flex items-center gap-2 rounded">
              <span class="pointer-events-none select-none text-gray-300 font-medium text-sm ">Cursos</span>
              <svg class="w-3 h-3 pointer-events-none text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
              </svg>
            </button>
            <div class="dropdown-menu absolute z-10 hidden bg-black text-white rounded-b-lg pb-2 w-48">
              <a href="{{ url('cursosAdm') }}" class="block px-6 py-2 hover:bg-red-600 rounded-2xl">Administração</a>
              <a href="{{ url('cursosCont') }}" class="block px-6 py-2 hover:bg-red-600 rounded-2xl">Contabilidade</a>
              <a href="{{ url('cursosAds') }}" class="block px-6 py-2 hover:bg-red-600 rounded-2xl">Desenvolvimente de Sistemas</a>
              <a href="{{ url('cursosLog') }}" class="block px-6 py-2 hover:bg-red-600 rounded-2xl">Logística</a>
              <a href="{{ url('cursosRH') }}" class="block px-6 py-2 hover:bg-red-600 rounded-2xl">Recursos Humanos</a>
              <a href="{{ url('cursosSJ') }}" class="block px-6 py-2 hover:bg-red-600 rounded-2xl">Serviços Jurídicos</a>
            </div>
          </div>
  ...
  <div class="sm:hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pb-3 pt-2">
      ...
      <div class="dropdown-menu absolute z-10 hidden bg-black text-white rounded-b-lg pb-2 w-48">
              <a href="{{ url('cursosAdm') }}" class="block px-6 py-2 hover:bg-red-600">Administração</a>
              <a href="{{ url('cursosCont') }}" class="block px-6 py-2 hover:bg-red-600 ">Contabilidade</a>
              <a href="{{ url('cursosAds') }}" class="block px-6 py-2 hover:bg-red-600">Desenvolvimente de Sistemas</a>
              <a href="{{ url('cursosLog') }}" class="block px-6 py-2 hover:bg-red-600">Logística</a>
              <a href="{{ url('cursosRH') }}" class="block px-6 py-2 hover:bg-red-600">Recursos Humanos</a>
              <a href="{{ url('cursosSJ') }}" class="block px-6 py-2 hover:bg-red-600">Serviços Jurídicos</a>
          </div>
...
<div class="relative isolate overflow-hidden bg-black py-24 sm:py-32 dark:bg-white-dark min-h-[630px] after:content-[''] after:h-full after:w-full after:absolute after:left-0 after:top-0 after:bg-[#1414149c] ">
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="font-bold text-white text-sm mb-10 z-50 mt-24 ml-14">ADMINISTRAÇÃO</h2>
      <p class="text-white text-3xl -bottom-2 relative tracking-tight font-bold z-50 ml-14">Desvendando os Segredos do Mundo </br> Empresarial: Curso Técnico de Administração </br> – Conectando Passado, Presente e Futuro!</p>
    </div>
...
<div class="flex flex-col justify-center md:flex-row items-center mt-5 text-white pt-10 md:pt-0 px-8 md:px-20">
    ...
    <div class="md:w-1/2 md:ml-10 md:order-2">
        ...
        <p class="font-normal text-base text-justify" style="color: #CDC0C0">Empresas privadas, seja de comércio, serviço ou indústria, órgãos públicos (prefeituras, secretarias de governo, ministérios do governo federal etc.) e ONGs. </br></br>O candidato que ingressar no curso técnico de Administração, na modalidade AMS, poderá prosseguir os estudos em uma Fatec no curso superior de tecnologia em  <a href="#"><span class="text-blue-400">Processos Gerenciais.</span></a> 
    </div>
</div>
