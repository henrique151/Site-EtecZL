...
<div class="relative isolate overflow-hidden bg-black py-24 sm:py-32 dark:bg-white-dark min-h-[630px] after:content-[''] after:h-full after:w-full after:absolute after:left-0 after:top-0 after:bg-[#1414149c] ">
  <img src="https://www.eteczonaleste.com.br/wp-content/uploads/2023/11/campaign-creators-gMsnXqILjp4-unsplash-scaled.jpg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center after:bg-[#1414149c]">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="font-bold text-white text-sm mb-10 z-50 mt-24 ml-14">RECURSOS HUMANOS</h2>
      <p class="mt text-white text-3xl -bottom-2 relative tracking-tight font-bold z-50 ml-14">Gestão de Pessoas em Foco: Desbravando os </br>Desafios do Setor de Recursos Humanos com </br> Língua Portuguesa, Matemática e História!</p>
    </div>
...
<div class="flex flex-col justify-center md:flex-row items-center mt-5 text-white p-8 md:px-20">
    ...
    <div class="md:w-5/12 md:ml-24 md:order-2">
        ...
        <p class="font-normal text-base text-justify" style="color: #CDC0C0">No setor de Recursos Humanos ou na área administrativa de empresas públicas e privadas de qualquer segmento, empresas de treinamento e desenvolvimento e agências de emprego.</p> 
    </div>
</div>
