            ...
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="navigation-menu hidden sm:flex flex-1 justify-end items-center space-x-4 relative" id="navigation-menu">
                    ...
                    <a href="{{ url('departamentos') }}"
                        class="text-gray-300 bg-red-600 rounded-md px-3 py-2 text-sm font-medium">Departamentos</a>
...
<div class="relative isolate overflow-hidden bg-black py-24 sm:py-32 dark:bg-white-dark min-h-[630px] after:content-[''] after:h-full after:w-full after:absolute after:left-0 after:top-0 after:bg-[#1414149c] ">
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="font-bold  text-sm mb-5 z-50 mt-24 ml-14 relative" style="color: #B2B6BB">DEPARTAMENTOS</h2>
      <p class="text-white text-3xl -bottom-2 relative tracking-tight font-bold z-50 ml-14">Coordenação de Cursos &  </br> Equipe Direção</p>
...
<div class="flex flex-col justify-left md:flex-row items-center mt-5 text-white p-8 md:px-20">
    <div class="md:w-12/12 md:ml-10 md:order-1">
        <h1 class="text-3xl font-bold mb-4" style="color: #E1E1D4">Coordenador Novotec</h1>
        <p class="font-normal text-base" style="color: #CDC0C0">Giovanna Littiere (Novotec Administração) </br>
...
<div class="flex flex-col justify-left md:flex-row items-center mt-5 text-white p-8 md:px-20">
    <div class="md:w-12/12 md:ml-10 md:order-1">
        <h1 class="text-3xl font-bold mb-4" style="color: #E1E1D4">Coordenador Curso Técnico</h1>
        <p class="font-normal text-base" style="color: #CDC0C0">Monyse Tesser Panacci (Técnico em Adminstração / Técnico em Contabilidade) </br>
...
<div class="flex flex-col justify-left md:flex-row items-center mt-5 text-white p-8 md:px-20">
    <div class="md:w-12/12 md:ml-10 md:order-1">
        <h1 class="text-3xl font-bold mb-4" style="color: #E1E1D4">Contato</h1>
        <p class="font-normal text-base" style="color: #CDC0C0">Telefones: (11) 2045-4018 | (11) 2045-4016 | (11) 2045-4011
        <p class="font-normal text-base" style="color: #CDC0C0">E-mail:<span class="text-blue-400"><a href="">e211dir@cps.sp.gov.br</a></span>
        </p>
      </div>
</div>
...
<div class="flex flex-col justify-left md:flex-row items-center mt-5 text-white p-8 md:px-20">
    <div class="md:w-12/12 md:ml-10 md:order-1">
        <h1 class="text-3xl font-bold mb-4" style="color: #E1E1D4">Diretor(a) da Etec</h1>
        <p class="font-normal text-base" style="color: #CDC0C0">Amanda Bueno  
        </p>
      </div>
</div>
...
<div class="flex flex-col justify-left md:flex-row items-center mt-5 text-white p-8 md:px-20">
    <div class="md:w-12/12 md:ml-10 md:order-1">
        <h1 class="text-3xl font-bold mb-4" style="color: #E1E1D4">Assessor Técnico Administrativo II </h1>
        <p class="font-normal text-base" style="color: #CDC0C0">Patrick Moreno da Silva  
        </p>
      </div>
</div>
